...
export default function WelcomeTab() {
  return (
    <div className="fade-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '28px' }} className="stagger">
        {/* AM Card */}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }} className="stagger">
        {[
          { icon: '📊', label: 'View Reports', desc: 'Latest analytics' },
          { icon: '📋', label: 'Deliverables', desc: "What's included" },
          { icon: '📁', label: 'Upload Assets', desc: 'Submit files' },
          { icon: '💬', label: 'Contact AM', desc: 'Get in touch' },
        ].map((link, i) => (
          <Card key={i} hoverable style={{ textAlign: 'center', padding: '24px 16px', cursor: 'pointer' }}>
